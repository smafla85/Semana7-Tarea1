...
const routes: Routes = [
  {
    ...
    children: [
      ...
      {
        path: 'nuevafacturafpdf',
        loadComponent: () => import('./facturas/nuevafacturafpdf/nuevafacturafpdf.component').then(m => m.NuevaFacturaFPDFComponent),
        canActivate: [usuariosGuardGuard]
      },
      {
        path: 'editarfacturafpdf/:id',
        loadComponent: () => import('./facturas/nuevafacturafpdf/nuevafacturafpdf.component').then(m => m.NuevaFacturaFPDFComponent),
        canActivate: [usuariosGuardGuard]
      },
      {
